...
export default function ContactMe() {
      return (
        <form class="w-full max-w-lg mx-auto pt-5">
        ...
        <div class="md:flex md:items-center">
          <div class="md:w-1/3">
            <button class="shadow bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-5 rounded" type="button">
              Send
            </button>
          </div>
